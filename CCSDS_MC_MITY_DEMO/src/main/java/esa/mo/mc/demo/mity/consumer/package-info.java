/**
This package contains a simple demonstration application of a service consumer. The consumer displays updates from the
provider on a simple grid and allows the registration for updates using either a wildcard or explicitly naming the
