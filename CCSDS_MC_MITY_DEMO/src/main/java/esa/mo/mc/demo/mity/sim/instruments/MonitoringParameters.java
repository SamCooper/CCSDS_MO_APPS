...
public class MonitoringParameters implements esa.mo.mc.demo.mity.provider.MonitoringParameters
{
  ...
  public double acquire(String name)
  {
    ...
    {
      case "GPS.Latitude":
        return instrumentSimulator.getGPSlatitude();
      case "GPS.Longitude":
        return instrumentSimulator.getGPSlongitude();
      case "GPS.Altitude":
        return instrumentSimulator.getGPSaltitude();
      case "GPS.Time":
        return instrumentSimulator.getGPStime().toEpochSecond(ZoneOffset.UTC);
      case "FineADCS.Magnetometer.B_r":
        return instrumentSimulator.getFineADCSmagnetometerBr();
      case "FineADCS.Magnetometer.B_theta":
        return instrumentSimulator.getFineADCSmagnetometerBtheta();
      case "Zero":
        return 0;
      case "One":
        return 1;
